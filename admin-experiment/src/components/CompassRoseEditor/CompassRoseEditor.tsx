...
import { describeSector, polarToCartesian, normalizeDeg } from "../../../../src/domain/direction";
import type { Band } from "../../domain/siteDraft";
import { CORE_COLOR_HEX, MARGIN_COLOR_HEX } from "../../domain/options";
import { findOverlappingBandPairs, resolveBandPush } from "../../domain/bandOverlap";
import { useAngleDrag } from "./useAngleDrag";
...
function makeBand(existing: Band[]): Band {
...
export function CompassRoseEditor({ bands, onChange }: Props) {
  ...
  function patchBand(id: string, patch: Partial<Band>) {
